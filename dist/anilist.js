...
const getTrending = (popular = false, page) => __awaiter(void 0, void 0, void 0, function* () {
    const query = `
  ...
  `;
    const [season, year] = (0, utils_1.getSeason)();
    const variables = {
        s: season,
        y: year,
        p: parseInt(page),
...
const getAnimeDetails = (animeTitle) => __awaiter(void 0, void 0, void 0, function* () {
    const query = `
